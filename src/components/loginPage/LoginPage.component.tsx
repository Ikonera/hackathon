...
const LoginPage: FunctionComponent = ({ history }) => {
        ...
        <Grid item container direction="column" className={classes.div_30} alignContent="center">
          <form onSubmit={handleSubmit}>
            <FormControl className={ classes.ctrl }>
              ...
              <TextField id="user-mail" className={ classes.entries } autoFocus variant="outlined" autoSave="false" onChange={e => setEmail(e.target.value)} required />
            </FormControl>
            <FormControl className={classes.ctrl}>
              <FormLabel htmlFor="user-password" className={ classes.labels }>
                Mot de passe
              </FormLabel>
              <TextField id="user-password" className={ classes.entries } variant="outlined" type="password" onChange={e => setPassword(e.target.value)} required/>
            </FormControl>
            <FormControl className={classes.ctrl}>
